  ...
  return (
    <div className="p-6 max-w-6xl mx-auto space-y-6">
      <div className="flex justify-between items-center bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
        <div>
          <h1 className="text-2xl font-bold tracking-tight text-slate-800">Manajemen Kurikulum</h1>
          <p className="text-sm text-slate-500 mt-1">Konfigurasi jenis kurikulum, komponen nilai, dan KKM</p>
        </div>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 flex gap-4 items-end">
        <label className="flex-1">
          ...
          <select
            className="w-full rounded-xl border-slate-200 bg-slate-50 px-4 py-2.5 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
      ...
      {loading ? (
        <div className="p-8 text-center text-slate-500 animate-pulse bg-white rounded-2xl">Memuat...</div>
      ) : curriculum ? (
        <div className="grid md:grid-cols-2 gap-6">
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <h2 className="text-lg font-bold text-slate-800 border-b pb-2">Info Kurikulum</h2>
          ...
          <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-100 space-y-4">
            <h2 className="text-lg font-bold text-slate-800 border-b pb-2">Komponen Nilai</h2>
            ...
            {!curriculum.isLocked && (
              <div className="mt-4 pt-4 border-t border-slate-100 space-y-3">
                <div className="flex gap-2">
                  <input
                    type="text"
                    placeholder="Nama Komponen (cth: Formatif)"
          ...
          <div className="md:col-span-2 bg-white p-6 rounded-2xl shadow-sm border border-slate-100">
            <h2 className="text-lg font-bold text-slate-800 border-b pb-4 mb-4">Pengaturan KKM & KKTP Mapel</h2>
        ...
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 text-center space-y-4">
          ...
          <div>
            ...
            <p className="text-sm text-slate-500 mt-1 max-w-sm mx-auto">Tahun ajaran {selectedYearId} semester {semester} belum dikonfigurasi. Pilih kurikulum yang akan dipakai untuk membuat data.</p>
          </div>
          <div className="flex max-w-sm mx-auto gap-2 pt-2">
            <select
              className="flex-1 rounded-xl border-slate-200 bg-slate-50 px-4 py-2 outline-none focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200"
              value={formType}
            ...
            <button
              ...
              className="px-6 border border-transparent bg-indigo-600 text-white font-semibold rounded-xl hover:bg-indigo-700 shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Buat Set
            </button>
          </div>
