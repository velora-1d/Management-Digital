    ...
    try {
      ...
      Swal.fire({
        ...
        didOpen: () => {
          ...
          (document.getElementById("swal-inv-qty") as HTMLInputElement).value = item.quantity?.toString() || "1";
          ...
          (document.getElementById("swal-inv-cost") as HTMLInputElement).value = item.acquisitionCost?.toString() || "0";
        },
        showCancelButton: true,
        confirmButtonText: "Simpan",
        cancelButtonText: "Batal",
