    ...
    try {
      ...
      Swal.fire({
        ...
        html: `
          <div style="text-align:left;display:grid;gap:0.75rem;">
            <div><label style="font-size:0.75rem;font-weight:600;">Nama Barang</label>
            <input id="swal-inv-name" class="swal2-input" value="${escapeHtml(item.name || "")}" style="margin:0;height:2.5rem;font-size:0.875rem;"></div>

            <div><label style="font-size:0.75rem;font-weight:600;">Kategori</label>
            <input id="swal-inv-cat" class="swal2-input" value="${escapeHtml(item.category || "")}" style="margin:0;height:2.5rem;font-size:0.875rem;"></div>
            ...
            <div><label style="font-size:0.75rem;font-weight:600;">Lokasi</label>
            <input id="swal-inv-loc" class="swal2-input" value="${escapeHtml(item.location || "")}" style="margin:0;height:2.5rem;font-size:0.875rem;"></div>
              ...
              {isLoading ? (
                ...
                data.map((item, i) => {
                  ...
                  if (item.condition === "Baik") {
                    badgeElement = <span className="px-3 py-1 bg-emerald-50 text-emerald-700 font-bold text-xs rounded-full border border-emerald-100">Baik</span>;
                  } else if (item.condition === "Rusak Ringan") {
                    badgeElement = <span className="px-3 py-1 bg-amber-50 text-amber-700 font-bold text-xs rounded-full border border-amber-100">Rusak Ringan</span>;
                  } else {
                    badgeElement = <span className="px-3 py-1 bg-red-50 text-red-700 font-bold text-xs rounded-full border border-red-100">Rusak Berat</span>;
                  }
                  ...
                  return (
                    <tr key={item.id} className="hover:bg-slate-50 transition-colors" style={{ borderBottom: "1px solid #f1f5f9" }}>
                      ...
                      <td style={{ padding: "1.25rem 1.5rem", textAlign: "center", verticalAlign: "middle" }}>{badgeElement}</td>
